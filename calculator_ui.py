...
class CalculatorUI(tk.Tk):
    ...
    def init_display(self):
        ...
        self.history_show = ttk.Label(self, textvariable=self.history_text, font=('Arial', 20), justify='right',
                                       anchor='e')
    ...
    def handle_keypad_event(self, event):
        ...
        if button_text == '=':
            ...
            if isinstance(result, Exception):
                s.configure('Custom.TLabel', foreground='red')
                self.bell()
            else:
                ...
                s.configure('Custom.TLabel', foreground='white')
